...
- 全名：Econometrica
- 榜单归属：FT50
- 主要领域：Economics；Econometrics；Economic Theory；Quantitative Economics；Applied Economics
- 出版方 / 学会：Econometric Society
- 官方 About：https://www.econometricsociety.org/publications/econometrica/about
...
适合 Econometrica 的主题包括：

- **Economic theory**：微观理论、博弈论、信息经济学、机制设计、契约、匹配、市场设计、一般均衡。
- **Econometric theory**：识别、估计、推断、面板、时间序列、结构模型、非参数/半参数方法。
- **Quantitative economics**：严谨定量模型、结构估计、计算经济学、动态模型。
- **Empirical economics with strong method or mechanism**：经验研究必须不仅有好数据，还要有严谨识别、模型或统计方法。
...
- **Frontier theory contribution**：推进经济理论或计量理论前沿。
- **Methodological contribution**：提出重要统计、计量或定量分析方法，并服务于经济问题。
- **Structural / quantitative empirical contribution**：用模型和数据共同解释经济机制。
...
- 重要性和相关性必须在正文早期说清楚。
- 贡献不能只靠技术复杂性，必须 interesting and original。
- 分析要 well-crafted，证明、识别、估计、实验或计算细节不能松散。
...
- 论文有清楚的经济学核心问题。
- 理论、计量、统计或定量方法是贡献的关键部分。
- 方法严谨性本身能经受顶级经济学审稿。
- 应用场景能产生一般经济学或方法启示。
- 文章写作高度精确，模型、假设、定理、识别和估计逻辑清楚。

不适合 Econometrica 的情况：
...
```text
目标期刊是 Econometrica。
请按 Econometric Society 顶刊标准评估论文：论文可来自所有经济学分支，但必须 grounded in rigorous analysis，并在经济理论、计量理论、定量经济学、应用经济问题或经验研究上有 interesting、original、well-crafted 的贡献。

优先检查：
1. 是否有明确经济学问题，而不是纯技术练习。
2. 理论、计量、统计或定量方法是否是核心贡献。
3. 分析是否严谨、完整、可检验、可复现。
4. 应用研究是否具有一般经济学或方法启示。
...
- Econometrica Editorial Procedures and Policies：https://www.econometricsociety.org/publications/econometrica/editorial-procedures-and-policies
