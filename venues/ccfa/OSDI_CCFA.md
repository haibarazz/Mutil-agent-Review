...
- 简写：OSDI
- 全名：USENIX Symposium on Operating Systems Design and Implementation
- 文件名：OSDI_CCFA.md
- 类型：会议
- 榜单归属：CCF-A
...
OSDI 是 CCF 推荐目录中 **软件工程/系统软件/程序设计语言** 领域的 A 类会议。软件工程、系统软件和程序设计语言方向的顶级 venue，适合软件开发、程序分析、编译器、操作系统、PL 和形式化方法研究。
...
- 论文贡献与 USENIX Symposium on Operating Systems Design and Implementation 的全名和领域传统一致。
...
- OSDI 官方定位为 operating systems design and implementation，系统领域旗舰会议。
- 适合 OS、distributed systems、cloud/datacenter、storage、networked systems、security、ML systems、resource management 和生产系统经验。

#### 官方投稿与评审要求

- 论文应展示重要系统问题、设计、实现和深入评估，通常需要真实 workload、部署、开源 artifact 或生产经验。
- 评审看系统完整性、novel insight、工程质量、性能/可靠性和社区影响。

#### 给智能体的硬约束

- OSDI fit 要求 design and implementation 是核心。
- 只有算法概念或小型 prototype、缺少系统深度时 fit 弱。
...
```text
目标 venue 是 USENIX Symposium on Operating Systems Design and Implementation (OSDI)，CCF-A，类型为会议，所属 CCF 专业领域为：软件工程/系统软件/程序设计语言 / Software Engineering / System Software / Programming Languages。
