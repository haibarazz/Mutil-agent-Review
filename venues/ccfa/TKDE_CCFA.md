...
- 简写：TKDE
- 全名：IEEE Transactions on Knowledge and Data Engineering
- 文件名：TKDE_CCFA.md
- 类型：期刊
- 榜单归属：CCF-A
...
TKDE 是 CCF 推荐目录中 **数据库/数据挖掘/内容检索** 领域的 A 类期刊。数据库、数据挖掘和内容检索方向的顶级 venue，适合数据管理、数据系统、数据挖掘、信息检索和 Web 数据研究。
...
- 论文贡献与 IEEE Transactions on Knowledge and Data Engineering 的全名和领域传统一致。
...
- TKDE 官方定位为 knowledge and data engineering 期刊。
- 适合数据库、数据挖掘、知识发现、数据工程、知识图谱、信息检索、推荐、机器学习与数据管理交叉。

#### 官方投稿与评审要求

- 论文应有清晰数据/知识工程贡献，包含算法、系统、理论或实证评估，并使用强 baseline 和充分数据。
- 期刊稿件需要完整实验、复杂度/可扩展性和局限讨论。

#### 给智能体的硬约束

- TKDE fit 要求 data/knowledge engineering 核心。
- 泛 ML 方法若没有数据工程或知识工程问题，fit 弱。
...
```text
目标 venue 是 IEEE Transactions on Knowledge and Data Engineering (TKDE)，CCF-A，类型为期刊，所属 CCF 专业领域为：数据库/数据挖掘/内容检索 / Database / Data Mining / Content Retrieval。
