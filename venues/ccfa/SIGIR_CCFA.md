...
- 论文贡献与 International ACM SIGIR Conference on Research and Development in Information Retrieval 的全名和领域传统一致。
...
- Double-anonymous review；authors 必须完成 OpenReview profile。
- Desk rejection 风险包括 topical fit 不足、匿名违规、格式违规、页数违规、作者变更、抄袭、学术不端、暴露身份的代码仓库链接。
