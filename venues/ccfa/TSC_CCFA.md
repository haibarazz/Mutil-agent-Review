...
- 简写：TSC
- 全名：IEEE Transactions on Services Computing
- 文件名：TSC_CCFA.md
- 类型：期刊
- 榜单归属：CCF-A
...
TSC 是 CCF 推荐目录中 **软件工程/系统软件/程序设计语言** 领域的 A 类期刊。软件工程、系统软件和程序设计语言方向的顶级 venue，适合软件开发、程序分析、编译器、操作系统、PL 和形式化方法研究。
...
- 论文贡献与 IEEE Transactions on Services Computing 的全名和领域传统一致。
...
- IEEE Transactions on Services Computing: https://www.computer.org/csdl/journal/sc

来源类型：官方 Aims & Scope / About / Author 页面

#### 官方定位与主题范围

- TSC 官方定位为 services computing，覆盖服务系统、服务组合、云服务、Web services 和服务工程。
- 适合 service-oriented architecture、microservices、cloud/edge services、service composition、QoS、workflow、business process、AI-enabled services。

#### 官方投稿与评审要求

- 论文应围绕服务计算问题提出模型、系统、算法或工程方法，并验证 QoS、可靠性、可扩展性或业务/流程价值。
- 期刊稿件需要完整系统上下文和实证评估。

#### 给智能体的硬约束

- TSC fit 不是普通云应用；必须有 service computing/service engineering 贡献。
- 缺少服务抽象、组合、质量或治理问题时 fit 弱。
...
```text
目标 venue 是 IEEE Transactions on Services Computing (TSC)，CCF-A，类型为期刊，所属 CCF 专业领域为：软件工程/系统软件/程序设计语言 / Software Engineering / System Software / Programming Languages。
