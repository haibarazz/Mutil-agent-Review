...
- 简写：ICSE
- 全名：International Conference on Software Engineering
- 文件名：ICSE_CCFA.md
- 类型：会议
- 榜单归属：CCF-A
...
ICSE 是 CCF 推荐目录中 **软件工程/系统软件/程序设计语言** 领域的 A 类会议。软件工程、系统软件和程序设计语言方向的顶级 venue，适合软件开发、程序分析、编译器、操作系统、PL 和形式化方法研究。
...
- 论文贡献与 International Conference on Software Engineering 的全名和领域传统一致。
...
- ICSE 官方定位为 software engineering 旗舰会议，覆盖软件开发生命周期和软件工程研究。
- 适合 requirements、design、testing、maintenance、evolution、developer productivity、SE education、software analytics、AI/ML for SE、SE for AI。

### 官方投稿与评审要求

- 论文应有明确 SE research question、方法/工具/理论/实证贡献和严谨评估。
- 评审会关注 practical relevance、methodological rigor、artifact/data、statistical validity 和对 SE 社区的贡献。

### 给智能体的硬约束

- ICSE fit 不等于写了一个软件系统；必须回答软件工程研究问题。
- 只有工程实现无研究问题/评估时 fit 弱。

## 智能体提示词片段

```text
目标 venue 是 International Conference on Software Engineering (ICSE)，CCF-A，类型为会议，所属 CCF 专业领域为：软件工程/系统软件/程序设计语言 / Software Engineering / System Software / Programming Languages。
