...
- 简写：TSE
- 全名：IEEE Transactions on Software Engineering
- 文件名：TSE_CCFA.md
- 类型：期刊
- 榜单归属：CCF-A
...
TSE 是 CCF 推荐目录中 **软件工程/系统软件/程序设计语言** 领域的 A 类期刊。软件工程、系统软件和程序设计语言方向的顶级 venue，适合软件开发、程序分析、编译器、操作系统、PL 和形式化方法研究。
...
- 论文贡献与 IEEE Transactions on Software Engineering 的全名和领域传统一致。
...
- TSE 官方定位为 software engineering 旗舰期刊。
- 适合需求、设计、开发、测试、维护、演化、质量、工具、过程、软件 analytics、AI for SE 和 SE empirical research。

#### 官方投稿与评审要求

- 论文应有完整 SE research design、清晰贡献、充分数据/实验/理论和有效性威胁讨论。
- 期刊要求比会议更完整的证据链和实践/理论意义。

#### 给智能体的硬约束

- TSE fit 要求软件工程问题和方法严谨性。
- 仅代码实现或模型结果，没有 SE 研究问题时 fit 弱。
...
```text
目标 venue 是 IEEE Transactions on Software Engineering (TSE)，CCF-A，类型为期刊，所属 CCF 专业领域为：软件工程/系统软件/程序设计语言 / Software Engineering / System Software / Programming Languages。
