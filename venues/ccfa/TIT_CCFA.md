...
- 简写：TIT
- 全名：IEEE Transactions on Information Theory
- 文件名：TIT_CCFA.md
- 类型：期刊
- 榜单归属：CCF-A
...
TIT 是 CCF 推荐目录中 **计算机科学理论** 领域的 A 类期刊。计算机科学理论方向的顶级 venue，适合算法、复杂性、计算理论、密码理论、逻辑和理论计算机科学研究。
...
- 论文贡献与 IEEE Transactions on Information Theory 的全名和领域传统一致。
...
- IEEE Transactions on Information Theory: https://www.itsoc.org/publications/transactions-information-theory

来源类型：官方 Aims & Scope / About / Author 页面

#### 官方定位与主题范围

- TIT 官方定位为 information theory 旗舰期刊。
- 适合 Shannon theory、coding theory、通信理论、统计信号处理理论、学习/隐私/安全的信息论基础、压缩、网络信息论。

#### 官方投稿与评审要求

- 论文应有信息论模型、定理、证明或严格分析，实验通常不是核心。
- 需要清楚假设、界、最优性或理论意义。

#### 给智能体的硬约束

- TIT fit 要求信息论贡献。
- 只有通信/ML 实验而无信息论分析时 fit 弱。
...
```text
目标 venue 是 IEEE Transactions on Information Theory (TIT)，CCF-A，类型为期刊，所属 CCF 专业领域为：计算机科学理论 / Computer Science Theory。
