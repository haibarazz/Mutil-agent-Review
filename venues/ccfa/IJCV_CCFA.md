...
- 简写：IJCV
- 全名：International Journal of Computer Vision
- 文件名：IJCV_CCFA.md
- 类型：期刊
- 榜单归属：CCF-A
...
IJCV 是 CCF 推荐目录中 **人工智能** 领域的 A 类期刊。人工智能方向的顶级 venue，适合机器学习、人工智能、计算机视觉、自然语言处理、表示学习和智能系统研究。
...
- 研究问题属于 **人工智能** 的核心问题。
- 论文贡献与 International Journal of Computer Vision 的全名和领域传统一致。
...
- International Journal of Computer Vision Aims and Scope: https://link.springer.com/journal/11263/aims-and-scope

来源类型：官方 Aims & Scope / About / Author 页面

#### 官方定位与主题范围

- IJCV 官方定位为 computer vision 旗舰期刊。
- 适合视觉理论、识别、几何、重建、分割、视频、视觉学习、视觉语言、多模态、低层视觉和视觉系统。

#### 官方投稿与评审要求

- 论文应有完整视觉研究贡献，包含方法、理论或系统，实验需要强 baseline、消融和深入分析。
- 期刊版本应比会议版更完整，包括更多实验、证明、失败分析或扩展。

#### 给智能体的硬约束

- IJCV fit 要求 CV 核心问题。
- 纯 ML 方法若没有视觉问题 insight，fit 弱。
...
```text
目标 venue 是 International Journal of Computer Vision (IJCV)，CCF-A，类型为期刊，所属 CCF 专业领域为：人工智能 / Artificial Intelligence。
