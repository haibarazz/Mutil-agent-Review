...
- 研究问题属于 **人工智能** 的核心问题。
- 论文贡献与 International Conference on Machine Learning 的全名和领域传统一致。
...
- 官方 review criteria 要求：claims 必须由 reproducible experiments 和/或 sound theoretical analysis 支撑；贡献必须放在更广泛 scientific and ML literature 中，并与相关 prior work 区分。
- Authors are required to include an impact statement；accepted papers 还需要 lay summary。
