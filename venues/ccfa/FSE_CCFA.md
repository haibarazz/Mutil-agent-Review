...
- 简写：FSE
- 全名：ACM International Conference on the Foundations of Software Engineering
- 文件名：FSE_CCFA.md
- 类型：会议
- 榜单归属：CCF-A
...
FSE 是 CCF 推荐目录中 **软件工程/系统软件/程序设计语言** 领域的 A 类会议。软件工程、系统软件和程序设计语言方向的顶级 venue，适合软件开发、程序分析、编译器、操作系统、PL 和形式化方法研究。
...
- 论文贡献与 ACM International Conference on the Foundations of Software Engineering 的全名和领域传统一致。
...
- FSE 官方定位为 foundations of software engineering，覆盖软件工程的理论、方法、工具和实证研究。
- 适合 testing、analysis、maintenance、requirements、developer tools、software analytics、SE for AI、AI for SE、security/quality、empirical SE。

#### 官方投稿与评审要求

- 论文应对软件工程问题提供原创方法、理论、工具或实证 insight，并有严谨评估。
- FSE 通常重视问题重要性、技术贡献、实验设计、artifact 和对 SE 实践的影响。

#### 给智能体的硬约束

- FSE fit 要求软件工程问题是中心。
- 泛 AI/PL/系统论文如果不能说明 SE 贡献，应判为弱 fit。
...
```text
目标 venue 是 ACM International Conference on the Foundations of Software Engineering (FSE)，CCF-A，类型为会议，所属 CCF 专业领域为：软件工程/系统软件/程序设计语言 / Software Engineering / System Software / Programming Languages。
