...
- 简写：MobiCom
- 全名：ACM International Conference on Mobile Computing and Networking
- 文件名：MobiCom_CCFA.md
- 类型：会议
- 榜单归属：CCF-A
...
MobiCom 是 CCF 推荐目录中 **计算机网络** 领域的 A 类会议。计算机网络方向的顶级 venue，适合网络协议、网络系统、移动/无线网络、互联网测量和网络体系结构研究。
...
- 研究问题属于 **计算机网络** 的核心问题。
- 论文贡献与 ACM International Conference on Mobile Computing and Networking 的全名和领域传统一致。
...
- MobiCom 2026: https://sigmobile.org/mobicom/2026/

来源类型：官方 CFP / 官方会议页面

### 官方定位与主题范围

- MobiCom 官方定位为 mobile computing and networking 顶级会议。
- 适合移动/无线网络、移动系统、蜂窝/WiFi、edge/mobile sensing、IoT、mobile security/privacy、移动应用系统、measurements。

### 官方投稿与评审要求

- 论文通常需要真实移动场景、系统原型或大规模测量，并解释移动性、无线信道、能耗、隐私或部署约束。
- 评审重视技术新意、真实世界有效性和系统/协议评估。

### 给智能体的硬约束

- MobiCom fit 要求 mobile/wireless/networked systems 是核心。
- 普通手机应用或泛 IoT 原型若无移动网络/系统研究贡献，fit 弱。

## 智能体提示词片段

```text
目标 venue 是 ACM International Conference on Mobile Computing and Networking (MobiCom)，CCF-A，类型为会议，所属 CCF 专业领域为：计算机网络 / Computer Networks。
...
- 如果审稿人认为这是相邻领域论文，你如何解释它适合 MobiCom？
