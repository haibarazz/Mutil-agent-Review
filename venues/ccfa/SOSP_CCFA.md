...
- 简写：SOSP
- 全名：ACM Symposium on Operating Systems Principles
- 文件名：SOSP_CCFA.md
- 类型：会议
- 榜单归属：CCF-A
...
SOSP 是 CCF 推荐目录中 **软件工程/系统软件/程序设计语言** 领域的 A 类会议。软件工程、系统软件和程序设计语言方向的顶级 venue，适合软件开发、程序分析、编译器、操作系统、PL 和形式化方法研究。
...
- 论文贡献与 ACM Symposium on Operating Systems Principles 的全名和领域传统一致。
...
- SOSP 2026: https://sigops.org/s/conferences/sosp/2026/index.html

来源类型：官方 CFP / 官方会议页面

#### 官方定位与主题范围

- SOSP 官方定位为 operating systems principles，系统领域旗舰会议。
- 适合 OS、distributed systems、storage、networked systems、cloud infrastructure、systems for AI、安全/可靠系统和生产经验。

#### 官方投稿与评审要求

- 论文应展示系统原则、设计、实现、评估或经验 insight，强调对系统社区的长期价值。
- 评审关注问题重要性、设计清晰度、实现可信度、可扩展评估和可迁移经验。

#### 给智能体的硬约束

- SOSP fit 要求 systems principles，不只是系统实现。
- 没有清晰系统 insight 或只有局部工程优化时 fit 弱。
...
```text
目标 venue 是 ACM Symposium on Operating Systems Principles (SOSP)，CCF-A，类型为会议，所属 CCF 专业领域为：软件工程/系统软件/程序设计语言 / Software Engineering / System Software / Programming Languages。
