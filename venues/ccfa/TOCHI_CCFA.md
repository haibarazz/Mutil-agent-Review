...
- 简写：TOCHI
- 全名：ACM Transactions on Computer-Human Interaction
- 文件名：TOCHI_CCFA.md
- 类型：期刊
- 榜单归属：CCF-A
...
TOCHI 是 CCF 推荐目录中 **人机交互与普适计算** 领域的 A 类期刊。人机交互与普适计算方向的顶级 venue，适合 HCI、CSCW、交互系统、普适计算、可用性和社会计算研究。
...
- 论文贡献与 ACM Transactions on Computer-Human Interaction 的全名和领域传统一致。
...
- ACM TOCHI About: https://dl.acm.org/journal/tochi/about

来源类型：官方 Aims & Scope / About / Author 页面

#### 官方定位与主题范围

- TOCHI 官方定位为 computer-human interaction 旗舰期刊。
- 适合 HCI theory、interactive systems、user studies、design methods、social/technical interaction、accessibility、human-centered AI。

#### 官方投稿与评审要求

- 论文应提供完整 HCI 贡献，可能是实证、设计、理论、系统或方法学，并有严谨证据。
- 期刊稿件需要详细研究设计、分析、伦理和对 CHI 社区意义的说明。

#### 给智能体的硬约束

- TOCHI fit 要求 HCI/CHI 核心贡献。
- 只做界面实现或问卷描述，没有研究贡献时 fit 弱。
...
```text
目标 venue 是 ACM Transactions on Computer-Human Interaction (TOCHI)，CCF-A，类型为期刊，所属 CCF 专业领域为：人机交互与普适计算 / Human-Computer Interaction and Pervasive Computing。
...
- 如果审稿人认为这是相邻领域论文，你如何解释它适合 TOCHI？
