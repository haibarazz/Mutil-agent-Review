...
SICOMP 是 CCF 推荐目录中 **计算机科学理论** 领域的 A 类期刊。计算机科学理论方向的顶级 venue，适合算法、复杂性、计算理论、密码理论、逻辑和理论计算机科学研究。
...
- 论文贡献与 SIAM Journal on Computing 的全名和领域传统一致。
...
- SIAM Journal on Computing: https://www.siam.org/publications/siam-journals/siam-journal-on-computing-sicomp/

来源类型：官方 Aims & Scope / About / Author 页面

### 官方定位与主题范围

- SICOMP 官方定位为理论计算机科学和数学计算基础期刊。
- 适合算法、复杂性、数据结构、离散优化、计算几何、随机/近似算法、形式理论等。

### 官方投稿与评审要求

- 论文应有完整数学结果、证明和对计算理论的贡献。
- 期刊稿件需要严谨、完整、可复查的理论展开。
...
```text
目标 venue 是 SIAM Journal on Computing (SICOMP)，CCF-A，类型为期刊，所属 CCF 专业领域为：计算机科学理论 / Computer Science Theory。
...
- 如果审稿人认为这是相邻领域论文，你如何解释它适合 SICOMP？
