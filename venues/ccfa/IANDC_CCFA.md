...
- 简写：IANDC
- 全名：Information and Computation
- 文件名：IANDC_CCFA.md
- 类型：期刊
- 榜单归属：CCF-A
...
IANDC 是 CCF 推荐目录中 **计算机科学理论** 领域的 A 类期刊。计算机科学理论方向的顶级 venue，适合算法、复杂性、计算理论、密码理论、逻辑和理论计算机科学研究。
...
- 论文贡献与 Information and Computation 的全名和领域传统一致。
...
- Information and Computation Aims and Scope: https://www.sciencedirect.com/journal/information-and-computation/about/aims-and-scope

来源类型：官方 Aims & Scope / About / Author 页面

#### 官方定位与主题范围

- Information and Computation 官方定位为 theoretical computer science 期刊，覆盖计算、信息、逻辑和复杂性基础。
- 适合自动机、形式语言、复杂性、逻辑、语义、验证、算法理论、信息与计算基础。

#### 官方投稿与评审要求

- 论文应有完整理论结果和严谨证明，期刊稿件需要充分上下文和细节。
- 通常不适合只有实验的应用论文。

#### 给智能体的硬约束

- IANDC fit 要求理论/形式化计算贡献。
- 无证明或形式模型时 fit 弱。
...
```text
目标 venue 是 Information and Computation (IANDC)，CCF-A，类型为期刊，所属 CCF 专业领域为：计算机科学理论 / Computer Science Theory。
...
- 如果审稿人认为这是相邻领域论文，你如何解释它适合 IANDC？
