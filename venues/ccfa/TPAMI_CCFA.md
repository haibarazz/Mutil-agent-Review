...
- 简写：TPAMI
- 全名：IEEE Transactions on Pattern Analysis and Machine Intelligence
- 文件名：TPAMI_CCFA.md
- 类型：期刊
- 榜单归属：CCF-A
...
TPAMI 是 CCF 推荐目录中 **人工智能** 领域的 A 类期刊。人工智能方向的顶级 venue，适合机器学习、人工智能、计算机视觉、自然语言处理、表示学习和智能系统研究。
...
- 研究问题属于 **人工智能** 的核心问题。
- 论文贡献与 IEEE Transactions on Pattern Analysis and Machine Intelligence 的全名和领域传统一致。
...
- TPAMI 官方定位为 pattern analysis and machine intelligence 旗舰期刊。
- 适合 computer vision、pattern recognition、machine learning、AI perception、image/video analysis、statistical learning、视觉理解。

### 官方投稿与评审要求

- 论文应提供完整方法、理论或系统贡献，并用强实验、消融、数据集和泛化分析支撑。
- 期刊稿件需要充分扩展会议版，不能只是轻微增量。

### 给智能体的硬约束

- TPAMI fit 要求 pattern analysis / CV / ML 核心贡献。
- 普通应用分类或缺少深度分析的 benchmark 论文 fit 弱。

## 智能体提示词片段

```text
目标 venue 是 IEEE Transactions on Pattern Analysis and Machine Intelligence (TPAMI)，CCF-A，类型为期刊，所属 CCF 专业领域为：人工智能 / Artificial Intelligence。
...
- 如果审稿人认为这是相邻领域论文，你如何解释它适合 TPAMI？
