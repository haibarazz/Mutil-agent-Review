...
- 简写：IJHCS
- 全名：International Journal of Human-Computer Studies
- 文件名：IJHCS_CCFA.md
- 类型：期刊
- 榜单归属：CCF-A
...
IJHCS 是 CCF 推荐目录中 **人机交互与普适计算** 领域的 A 类期刊。人机交互与普适计算方向的顶级 venue，适合 HCI、CSCW、交互系统、普适计算、可用性和社会计算研究。
...
- 论文贡献与 International Journal of Human-Computer Studies 的全名和领域传统一致。
...
- International Journal of Human-Computer Studies Aims and Scope: https://www.sciencedirect.com/journal/international-journal-of-human-computer-studies/about/aims-and-scope

来源类型：官方 Aims & Scope / About / Author 页面

#### 官方定位与主题范围

- IJHCS 官方定位为 human-computer studies，覆盖人与计算系统交互的理论、方法和实证研究。
- 适合 HCI、user experience、cognitive/behavioral aspects、interactive systems、usability、human-centered AI、accessibility。

#### 官方投稿与评审要求

- 论文应有清晰 HCI 研究问题、合适方法学、用户/行为/系统证据和对人机交互理论或实践的贡献。
- 期刊稿件需要充分方法透明度、伦理说明和 validity 讨论。

#### 给智能体的硬约束

- IJHCS fit 要求人与计算交互是核心。
- 纯技术系统无用户/交互研究问题时 fit 弱。
...
```text
目标 venue 是 International Journal of Human-Computer Studies (IJHCS)，CCF-A，类型为期刊，所属 CCF 专业领域为：人机交互与普适计算 / Human-Computer Interaction and Pervasive Computing。
...
- 如果审稿人认为这是相邻领域论文，你如何解释它适合 IJHCS？
