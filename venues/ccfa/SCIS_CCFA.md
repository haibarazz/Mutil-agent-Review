...
- 简写：SCIS
- 全名：Science China Information Sciences
- 文件名：SCIS_CCFA.md
- 类型：期刊
- 榜单归属：CCF-A
- CCF 专业领域：交叉/综合/新兴 / Cross-disciplinary / Comprehensive / Emerging
- 出版方 / 主办方：Science in China Press/Springer
- CCF 官方目录入口：https://www.ccf.org.cn/Academic_Evaluation/By_category/

## 一句话定位

SCIS 是 CCF 推荐目录中 **交叉/综合/新兴** 领域的 A 类期刊。交叉、综合和新兴方向的顶级 venue，适合 Web、实时系统、计算生物、跨学科计算和新兴计算问题研究。
...
- 论文贡献与 Science China Information Sciences 的全名和领域传统一致。
...
- Science China Information Sciences Aims and Scope: https://link.springer.com/journal/11432/aims-and-scope

来源类型：官方 Aims & Scope / About / Author 页面

### 官方定位与主题范围

- SCIS 官方定位为 information sciences 综合期刊，覆盖计算机科学、信息技术、自动化、通信、控制等信息科学领域。
- 适合信息科学中的理论、方法、系统和应用，包括计算、网络、AI、数据、软件、控制和电子信息交叉。

### 官方投稿与评审要求

- 论文应提供原创信息科学贡献，具有完整实验/理论/系统论证和跨信息科学读者可理解的价值。
- 期刊稿件需要清楚说明问题背景、技术新意和与国际相关工作的关系。

### 给智能体的硬约束

- SCIS fit 较宽，但仍要求信息科学研究贡献。
- 单纯业务应用或工程报告没有可推广技术贡献时 fit 弱。

## 智能体提示词片段

```text
目标 venue 是 Science China Information Sciences (SCIS)，CCF-A，类型为期刊，所属 CCF 专业领域为：交叉/综合/新兴 / Cross-disciplinary / Comprehensive / Emerging。
