...
- 简写：S&P
- 全名：IEEE Symposium on Security and Privacy
- 文件名：SandP_CCFA.md
- 类型：会议
- 榜单归属：CCF-A
...
S&P 是 CCF 推荐目录中 **网络与信息安全** 领域的 A 类会议。网络与信息安全方向的顶级 venue，适合密码学、系统安全、网络安全、隐私、安全攻防和安全协议研究。
...
- 论文贡献与 IEEE Symposium on Security and Privacy 的全名和领域传统一致。
...
- IEEE S&P 2026: https://www.ieee-security.org/TC/SP2026/

来源类型：官方 CFP / 官方会议页面

#### 官方定位与主题范围

- IEEE S&P 官方定位为 security and privacy 顶级会议。
- 适合系统、网络、软件、硬件、隐私、密码应用、人因安全、ML security、测量、政策与安全机制。

#### 官方投稿与评审要求

- 论文应给出重要安全/隐私问题、严谨方法、清晰 threat model、实验/证明/测量和伦理处理。
- 评审关注技术深度、影响、正确性、可复现性和负责任研究。

#### 给智能体的硬约束

- S&P fit 要求安全或隐私贡献达到顶级深度。
- 只有风险陈述而无技术贡献/证据时 fit 弱。
...
```text
目标 venue 是 IEEE Symposium on Security and Privacy (S&P)，CCF-A，类型为会议，所属 CCF 专业领域为：网络与信息安全 / Network and Information Security。
