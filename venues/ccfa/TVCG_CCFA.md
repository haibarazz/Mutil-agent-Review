...
- 简写：TVCG
- 全名：IEEE Transactions on Visualization and Computer Graphics
- 文件名：TVCG_CCFA.md
- 类型：期刊
- 榜单归属：CCF-A
...
TVCG 是 CCF 推荐目录中 **计算机图形学与多媒体** 领域的 A 类期刊。计算机图形学与多媒体方向的顶级 venue，适合图形、视觉化、多媒体、VR/AR、渲染和交互媒体研究。
...
- 论文贡献与 IEEE Transactions on Visualization and Computer Graphics 的全名和领域传统一致。
...
- IEEE Transactions on Visualization and Computer Graphics: https://www.computer.org/csdl/journal/tg

来源类型：官方 Aims & Scope / About / Author 页面

#### 官方定位与主题范围

- TVCG 官方定位为 visualization and computer graphics。
- 适合可视化、视觉分析、图形学、虚拟现实、HCI for visualization、数据可视化系统和评估。

#### 官方投稿与评审要求

- 论文应提出 visualization/graphics 技术、系统、设计研究或用户/感知评估。
- 期刊稿件需要完整方法、案例、实验和对目标用户/任务的说明。

#### 给智能体的硬约束

- TVCG fit 要求可视化或图形学贡献。
- 只是用图形界面展示算法结果时 fit 弱。
...
```text
目标 venue 是 IEEE Transactions on Visualization and Computer Graphics (TVCG)，CCF-A，类型为期刊，所属 CCF 专业领域为：计算机图形学与多媒体 / Computer Graphics and Multimedia。
