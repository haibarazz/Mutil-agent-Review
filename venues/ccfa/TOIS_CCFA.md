...
- 简写：TOIS
- 全名：ACM Transactions on Information Systems
- 文件名：TOIS_CCFA.md
- 类型：期刊
- 榜单归属：CCF-A
...
TOIS 是 CCF 推荐目录中 **数据库/数据挖掘/内容检索** 领域的 A 类期刊。数据库、数据挖掘和内容检索方向的顶级 venue，适合数据管理、数据系统、数据挖掘、信息检索和 Web 数据研究。
...
- 论文贡献与 ACM Transactions on Information Systems 的全名和领域传统一致。
...
- ACM TOIS About: https://dl.acm.org/journal/tois/about

来源类型：官方 Aims & Scope / About / Author 页面

#### 官方定位与主题范围

- TOIS 官方定位为 information systems，特别关注信息检索、信息访问、搜索、推荐和人机信息交互。
- 适合 IR models、search/recommendation、interactive IR、evaluation、user behavior、information access systems、NLP/ML for IR。

#### 官方投稿与评审要求

- 论文应围绕信息访问系统提出原创模型、算法、评估方法、用户研究或系统贡献。
- 期刊稿件需要严谨实验、用户/任务语境和对信息系统社区的贡献。

#### 给智能体的硬约束

- TOIS fit 要求 information retrieval/access/systems 核心。
- 只做通用 NLP/ML 而无信息访问问题时 fit 弱。
...
```text
目标 venue 是 ACM Transactions on Information Systems (TOIS)，CCF-A，类型为期刊，所属 CCF 专业领域为：数据库/数据挖掘/内容检索 / Database / Data Mining / Content Retrieval。
