...
- 简写：JSAC
- 全名：IEEE Journal on Selected Areas in Communications
- 文件名：JSAC_CCFA.md
- 类型：期刊
- 榜单归属：CCF-A
...
JSAC 是 CCF 推荐目录中 **计算机网络** 领域的 A 类期刊。计算机网络方向的顶级 venue，适合网络协议、网络系统、移动/无线网络、互联网测量和网络体系结构研究。
...
- 研究问题属于 **计算机网络** 的核心问题。
- 论文贡献与 IEEE Journal on Selected Areas in Communications 的全名和领域传统一致。
...
- JSAC 官方定位为 communications 领域 selected areas 期刊，通常围绕专题 issue 聚集前沿通信主题。
- 适合无线/移动、网络架构、通信理论、光/卫星/IoT、网络安全、ML for communications、通信系统和协议。

#### 官方投稿与评审要求

- 投稿通常需匹配具体 special issue scope；论文应有通信领域原创贡献和充分理论/实验/系统验证。
- 需要特别检查 call for papers of special issue，而不是只看总刊名。

#### 给智能体的硬约束

- JSAC fit 首先看 special issue fit，其次看 communications contribution。
- 泛 AI 或泛网络系统若不落入专题范围，不能建议投 JSAC。
...
```text
目标 venue 是 IEEE Journal on Selected Areas in Communications (JSAC)，CCF-A，类型为期刊，所属 CCF 专业领域为：计算机网络 / Computer Networks。
