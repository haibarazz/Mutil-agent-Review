...
AI 是 CCF 推荐目录中 **人工智能** 领域的 A 类期刊。人工智能方向的顶级 venue，适合机器学习、人工智能、计算机视觉、自然语言处理、表示学习和智能系统研究。
...
- 研究问题属于 **人工智能** 的核心问题。
- 论文贡献与 Artificial Intelligence 的全名和领域传统一致。
...
- Artificial Intelligence Aims and Scope: https://www.sciencedirect.com/journal/artificial-intelligence/about/aims-and-scope

来源类型：官方 Aims & Scope / About / Author 页面

### 官方定位与主题范围

- Artificial Intelligence 官方定位为 AI 领域综合性期刊，覆盖人工智能基础、方法和应用的原创研究。
- 适合知识表示、推理、规划、搜索、机器学习、NLP、CV、multiagent、robotics、AI foundations、AI applications with general AI contribution。

### 官方投稿与评审要求

- 论文应提供对 AI 理论、方法、系统或经验认识的完整贡献，而非狭窄工程应用。
- 期刊稿件通常需要更完整的背景、证明/实验和对 AI 社区意义的解释。

### 给智能体的硬约束

- AI journal fit 要求 general AI contribution。
- 只解决单一应用且没有可推广 AI insight 时 fit 弱。

## 智能体提示词片段

```text
目标 venue 是 Artificial Intelligence (AI)，CCF-A，类型为期刊，所属 CCF 专业领域为：人工智能 / Artificial Intelligence。
