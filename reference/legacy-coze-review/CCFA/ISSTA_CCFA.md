...
- 简写：ISSTA
- 全名：International Symposium on Software Testing and Analysis
- 文件名：ISSTA_CCFA.md
- 类型：会议
- 榜单归属：CCF-A
...
ISSTA 是 CCF 推荐目录中 **软件工程/系统软件/程序设计语言** 领域的 A 类会议。软件工程、系统软件和程序设计语言方向的顶级 venue，适合软件开发、程序分析、编译器、操作系统、PL 和形式化方法研究。
...
- 论文贡献与 International Symposium on Software Testing and Analysis 的全名和领域传统一致。
...
- ISSTA 官方定位为 software testing and analysis。
- 适合软件测试、程序分析、verification、debugging、fault localization、fuzzing、repair、security analysis、AI/ML testing。

### 官方投稿与评审要求

- 论文应提出测试/分析方法或工具，并用真实项目、benchmark、缺陷数据或理论分析证明有效性。
- 评审关注 soundness/precision/recall、scalability、bug-finding ability 和工程可用性。

### 给智能体的硬约束

- ISSTA fit 必须是 testing/analysis contribution。
- 普通 SE 工具若不解决测试或分析问题，fit 弱。

## 智能体提示词片段

```text
目标 venue 是 International Symposium on Software Testing and Analysis (ISSTA)，CCF-A，类型为会议，所属 CCF 专业领域为：软件工程/系统软件/程序设计语言 / Software Engineering / System Software / Programming Languages。
...
- 如果审稿人认为这是相邻领域论文，你如何解释它适合 ISSTA？
