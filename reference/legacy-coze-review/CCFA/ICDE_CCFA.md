...
- 简写：ICDE
- 全名：IEEE International Conference on Data Engineering
- 文件名：ICDE_CCFA.md
- 类型：会议
- 榜单归属：CCF-A
...
ICDE 是 CCF 推荐目录中 **数据库/数据挖掘/内容检索** 领域的 A 类会议。数据库、数据挖掘和内容检索方向的顶级 venue，适合数据管理、数据系统、数据挖掘、信息检索和 Web 数据研究。
...
- 论文贡献与 IEEE International Conference on Data Engineering 的全名和领域传统一致。
...
- ICDE 官方定位为 data engineering 顶级会议。
- 适合数据库系统、数据管理、数据工程、数据集成、查询处理、事务、流数据、图数据、AI/ML data systems、数据质量、隐私与治理。

### 官方投稿与评审要求

- 论文应提供数据工程问题的原创方法、系统或理论，并用真实数据、benchmark、系统实验或复杂度分析支撑。
- 评审关注 data management relevance、scalability、correctness、system design 和 empirical rigor。

### 给智能体的硬约束

- ICDE fit 要求 data engineering/data management 核心贡献。
- 只在数据集上跑 ML 模型但不推进数据工程问题，fit 弱。

## 智能体提示词片段

```text
目标 venue 是 IEEE International Conference on Data Engineering (ICDE)，CCF-A，类型为会议，所属 CCF 专业领域为：数据库/数据挖掘/内容检索 / Database / Data Mining / Content Retrieval。
