...
- 简写：SODA
- 全名：ACM-SIAM Symposium on Discrete Algorithms
- 文件名：SODA_CCFA.md
- 类型：会议
- 榜单归属：CCF-A
...
SODA 是 CCF 推荐目录中 **计算机科学理论** 领域的 A 类会议。计算机科学理论方向的顶级 venue，适合算法、复杂性、计算理论、密码理论、逻辑和理论计算机科学研究。
...
- 论文贡献与 ACM-SIAM Symposium on Discrete Algorithms 的全名和领域传统一致。
...
- SODA 2026: https://www.siam.org/conferences-events/siam-conferences/soda26/

来源类型：官方 CFP / 官方会议页面

### 官方定位与主题范围

- SODA 官方定位为 discrete algorithms 顶级会议。
- 适合算法设计与分析、图算法、随机算法、优化、数据结构、近似算法、在线算法、计算几何、算法应用理论。

### 官方投稿与评审要求

- 论文应提供新的算法、复杂度界、近似保证、下界或严谨理论分析。
- 实验可辅助，但核心通常是数学证明和算法 insight。

### 给智能体的硬约束

- SODA fit 要求算法理论贡献。
- 纯工程实现或无理论保证的 heuristic fit 弱。

## 智能体提示词片段

```text
目标 venue 是 ACM-SIAM Symposium on Discrete Algorithms (SODA)，CCF-A，类型为会议，所属 CCF 专业领域为：计算机科学理论 / Computer Science Theory。
