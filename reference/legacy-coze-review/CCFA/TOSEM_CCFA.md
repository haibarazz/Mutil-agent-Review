...
TOSEM 是 CCF 推荐目录中 **软件工程/系统软件/程序设计语言** 领域的 A 类期刊。软件工程、系统软件和程序设计语言方向的顶级 venue，适合软件开发、程序分析、编译器、操作系统、PL 和形式化方法研究。
...
- 论文贡献与 ACM Transactions on Software Engineering and Methodology 的全名和领域传统一致。
...
- ACM TOSEM About: https://dl.acm.org/journal/tosem/about

来源类型：官方 Aims & Scope / About / Author 页面

### 官方定位与主题范围

- TOSEM 官方定位为 software engineering and methodology 期刊。
- 适合软件开发方法、测试、分析、维护、需求、过程、工具、经验研究、软件质量和 SE theory。

### 官方投稿与评审要求

- 论文应提供完整 SE 研究贡献和严谨方法学，包括实验设计、数据、统计、工具 artifact 或工业证据。
- 期刊稿件需要充分讨论 validity threats、replicability、context 和实践意义。

### 给智能体的硬约束

- TOSEM fit 要求明确软件工程研究问题。
- 单纯算法或工具 demo 缺少 SE 方法学时 fit 弱。

## 智能体提示词片段

```text
目标 venue 是 ACM Transactions on Software Engineering and Methodology (TOSEM)，CCF-A，类型为期刊，所属 CCF 专业领域为：软件工程/系统软件/程序设计语言 / Software Engineering / System Software / Programming Languages。
...
- 如果审稿人认为这是相邻领域论文，你如何解释它适合 TOSEM？
