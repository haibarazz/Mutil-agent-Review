...
- 简写：FOCS
- 全名：IEEE Annual Symposium on Foundations of Computer Science
- 文件名：FOCS_CCFA.md
- 类型：会议
- 榜单归属：CCF-A
...
FOCS 是 CCF 推荐目录中 **计算机科学理论** 领域的 A 类会议。计算机科学理论方向的顶级 venue，适合算法、复杂性、计算理论、密码理论、逻辑和理论计算机科学研究。
...
- 论文贡献与 IEEE Annual Symposium on Foundations of Computer Science 的全名和领域传统一致。
...
- FOCS 2026 CFP: https://sanjeevkhanna.org/FOCS2026_CFP.html

来源类型：官方 CFP / 官方会议页面

### 官方定位与主题范围

- FOCS 官方定位为 foundations of computer science 顶级理论会议。
- 适合算法、复杂性、随机性、密码基础、学习理论、量子计算、组合、逻辑、计算经济学等理论计算机科学。

### 官方投稿与评审要求

- 论文通常需要原创定理、证明、下界/上界、模型或理论框架。
- 评审关注数学深度、原创性、正确性和对理论 CS 的影响。
...
```text
目标 venue 是 IEEE Annual Symposium on Foundations of Computer Science (FOCS)，CCF-A，类型为会议，所属 CCF 专业领域为：计算机科学理论 / Computer Science Theory。
