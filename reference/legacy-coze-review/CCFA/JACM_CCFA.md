...
JACM 是 CCF 推荐目录中 **交叉/综合/新兴** 领域的 A 类期刊。交叉、综合和新兴方向的顶级 venue，适合 Web、实时系统、计算生物、跨学科计算和新兴计算问题研究。
...
- 论文贡献与 Journal of the ACM 的全名和领域传统一致。
...
- Journal of the ACM About: https://dl.acm.org/journal/jacm/about

来源类型：官方 Aims & Scope / About / Author 页面

### 官方定位与主题范围

- JACM 官方定位为 ACM 旗舰综合期刊，发表计算机科学基础和广泛影响的高水平研究。
- 适合理论 CS、算法、复杂性、逻辑、形式方法、计算基础以及具有广泛 CS 影响的核心结果。

### 官方投稿与评审要求

- 论文应具有长期价值、严谨证明或深层理论/基础贡献，期刊稿件需要完整展开。
- JACM 通常不适合单一应用工程或窄领域增量。

### 给智能体的硬约束

- JACM fit 要求基础性、广泛性和理论/核心 CS 深度。
- 没有明确长期基础贡献时不应建议投 JACM。

## 智能体提示词片段

```text
目标 venue 是 Journal of the ACM (JACM)，CCF-A，类型为期刊，所属 CCF 专业领域为：交叉/综合/新兴 / Cross-disciplinary / Comprehensive / Emerging。
