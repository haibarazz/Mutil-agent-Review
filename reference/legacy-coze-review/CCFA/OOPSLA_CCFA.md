...
- 简写：OOPSLA
- 全名：Conference on Object-Oriented Programming Systems, Languages, and Applications
- 文件名：OOPSLA_CCFA.md
- 类型：会议
- 榜单归属：CCF-A
...
OOPSLA 是 CCF 推荐目录中 **软件工程/系统软件/程序设计语言** 领域的 A 类会议。软件工程、系统软件和程序设计语言方向的顶级 venue，适合软件开发、程序分析、编译器、操作系统、PL 和形式化方法研究。
...
- 论文贡献与 Conference on Object-Oriented Programming Systems, Languages, and Applications 的全名和领域传统一致。
...
- OOPSLA 2026: https://conf.researchr.org/track/splash-2026/oopsla-2026

来源类型：官方 CFP / 官方会议页面

### 官方定位与主题范围

- OOPSLA 官方定位为 programming languages and systems 会议，覆盖语言设计、实现、程序分析、软件系统和语言实践。
- 适合语言设计、类型系统、编译器、运行时、程序分析、并发、软件抽象、经验研究和 PL 工具。

### 官方投稿与评审要求

- 论文应提供 PL/systems 的原创概念、理论、实现或实证研究，并充分论证正确性、可用性或影响。
- OOPSLA 论文通常需要完整 artifact、形式化或系统实现支撑。

### 给智能体的硬约束

- OOPSLA fit 要求 programming language/software system abstraction 为核心。
- 只有应用软件或普通工具而无语言/系统抽象贡献时 fit 弱。

## 智能体提示词片段

```text
目标 venue 是 Conference on Object-Oriented Programming Systems, Languages, and Applications (OOPSLA)，CCF-A，类型为会议，所属 CCF 专业领域为：软件工程/系统软件/程序设计语言 / Software Engineering / System Software / Programming Languages。
...
- 如果审稿人认为这是相邻领域论文，你如何解释它适合 OOPSLA？
