...
- 简写：STOC
- 全名：ACM Symposium on the Theory of Computing
- 文件名：STOC_CCFA.md
- 类型：会议
- 榜单归属：CCF-A
...
STOC 是 CCF 推荐目录中 **计算机科学理论** 领域的 A 类会议。计算机科学理论方向的顶级 venue，适合算法、复杂性、计算理论、密码理论、逻辑和理论计算机科学研究。
...
- 论文贡献与 ACM Symposium on the Theory of Computing 的全名和领域传统一致。
...
- STOC 2026: https://acm-stoc.org/stoc2026/

来源类型：官方 CFP / 官方会议页面

### 官方定位与主题范围

- STOC 官方定位为 theory of computing 旗舰会议。
- 适合复杂性、算法、密码理论、量子计算、随机性、学习理论、博弈/经济计算、图论与离散数学等。

### 官方投稿与评审要求

- 论文应有高水平理论贡献，包含严谨定理、证明和与理论 CS 的清晰关系。
- 评审关注原创性、深度、正确性和广泛影响。

### 给智能体的硬约束

- STOC fit 必须是理论计算机科学。
- 没有形式化理论结果的系统/应用论文不适合。

## 智能体提示词片段

```text
目标 venue 是 ACM Symposium on the Theory of Computing (STOC)，CCF-A，类型为会议，所属 CCF 专业领域为：计算机科学理论 / Computer Science Theory。
