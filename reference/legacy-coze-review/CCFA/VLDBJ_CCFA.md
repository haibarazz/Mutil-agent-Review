...
VLDBJ 是 CCF 推荐目录中 **数据库/数据挖掘/内容检索** 领域的 A 类期刊。数据库、数据挖掘和内容检索方向的顶级 venue，适合数据管理、数据系统、数据挖掘、信息检索和 Web 数据研究。
...
- 论文贡献与 The VLDB Journal 的全名和领域传统一致。
...
- The VLDB Journal Aims and Scope: https://link.springer.com/journal/778/aims-and-scope

来源类型：官方 Aims & Scope / About / Author 页面

### 官方定位与主题范围

- VLDBJ 官方定位为 information systems and database systems 期刊，覆盖大规模数据管理研究。
- 适合数据库系统、数据模型、查询、事务、分布式数据、信息集成、数据挖掘与数据库交叉。

### 官方投稿与评审要求

- 论文应提供完整数据管理贡献和充分实验/理论/系统证据。
- 期刊版本要求更完整的相关工作、方法细节和有效性讨论。

### 给智能体的硬约束

- VLDBJ fit 要求 database/data management。
- 缺少数据管理问题的泛 AI/数据分析论文 fit 弱。

## 智能体提示词片段

```text
目标 venue 是 The VLDB Journal (VLDBJ)，CCF-A，类型为期刊，所属 CCF 专业领域为：数据库/数据挖掘/内容检索 / Database / Data Mining / Content Retrieval。
...
- 如果审稿人认为这是相邻领域论文，你如何解释它适合 VLDBJ？
