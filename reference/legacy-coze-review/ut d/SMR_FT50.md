# MIT Sloan Management Review (MIT SMR / SMR)
...
- 榜单归属：FT50
- 主要领域：Management Practice；Technology and Strategy；Digital Innovation；Leadership；Sustainable Business；Workforce
- 出版方：MIT Sloan Management Review / MIT Sloan School of Management
- 官方主页：https://sloanreview.mit.edu
...
- **Strategic Leadership**：战略制定与执行、领导多元/混合团队、不确定时代领导技能。
- **Digital Innovation**：技术对战略、运营和 workforce 的影响；AI 和其他 emerging technologies 的演化与应用。
- **Sustainable Business**：业务韧性、DEI、环境可持续、stakeholder capitalism。
- **Innovation management**：新想法、新框架、新组织实践如何改造管理。
...
- **Fresh thinking**：新想法需要有潜力改变 management thinking and practices，并说明相对已有工作的推进。
- **Direct relevance to managers**：必须对业务专业人士有清楚价值，直接影响管理者如何理解或处理当前紧迫问题。
...
- 问题来自当前管理者正在面对的真实挑战。
- 观点有新意，并能推进 management thinking。
- 能转成行动框架、管理原则、决策清单或实践建议。
- 有研究、数据、案例或实践经验支撑。
- 语言面向 business executives，而不是学术审稿人。
- 主题优先落在战略领导、数字创新和可持续商业三大方向。

不适合 SMR 的情况：

- 纯学术论文，没有转译成管理者可以应用的 insight。
- 泛泛谈 AI、领导力或可持续，没有新框架或新证据。
- 只有观点，没有 strong case。
- 只服务于产品宣传或咨询销售。
...
注意：MIT SMR 官方 Author Guidelines 于 2026-05-22 更新，说明 MIT Sloan School 将在 2026 年晚些时候停止出版 MIT SMR，且当前不再接受 submissions。除非用户明确说明是做历史资料、风格参考或已有编辑关系，不要把 SMR 当作可正常投稿目标。
...
- 这个想法如何直接帮助管理者处理当前紧迫问题？
- 你的 fresh thinking 相对已有管理讨论的新意是什么？
- 你有什么原创研究、案例或经验来支撑论证？
